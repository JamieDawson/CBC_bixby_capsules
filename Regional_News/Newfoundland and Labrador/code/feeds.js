...
module.exports = module.exports = [
  {
    ...
    text: 'CBC Newfoundland and Labrador',
    image: './icon.png',
    description: "The latest news from CBC about Newfoundland and Labrador.",
    tags: ['canada', 'cbc','top stories', 'Newfoundland', 'Labrador']
  }
]