...
module.exports = module.exports = [
  {
    url: 'https://rss.cbc.ca/lineup/sports-figureskating.xml',
    urlText: 'Click here to see the full story on cbc.ca',
    text: 'CBC Figure Skating',
    image: './icon.png',
    description: "The latest news from CBC about Figure Skating.",
    tags: ['canada', 'cbc','top stories', 'sports', 'figure skating', 'skating']
  }
]